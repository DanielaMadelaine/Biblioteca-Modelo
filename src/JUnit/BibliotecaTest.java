	...
	public void setUp() throws Exception {
		...
		// Cargamos los tipos de libro
				...
				//biblioteca.listarLibros();
				 ...
				 biblio.PrestarLibro(libro2, LectorA);
				
				 biblio.PrestarLibro(libro5, LectorA);
				LectorA.setMulta(new Multa(LectorA));
				biblio.PrestarLibro(libro6, LectorA);
				biblio.PrestarLibro(libro9, LectorA);
				
				//biblio.listarLibros();
				
				biblio.DevolverLibro(libro4, LectorA);
				biblio.DevolverLibro(libro2, LectorA);
